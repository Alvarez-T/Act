...
public sealed class FileScanner(IAmsiScanner amsi) : IFileScanner
{
    public string HashFile(string filePath)
    {
        ...
        return global::System.Convert.ToHexStringLower(hash);
    }
...
#pragma warning restore SYSLIB0057
    ...
    {
        if (!global::System.IO.Directory.Exists(directoryPath)) return [];

        var files = global::System.IO.Directory.GetFiles(directoryPath, searchPattern, global::System.IO.SearchOption.AllDirectories);
        var results = new global::System.Collections.Generic.List<FileScanResult>(files.Length);
