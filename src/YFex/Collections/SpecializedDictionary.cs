...
//Source: https://github.com/CommunityToolkit/dotnet/blob/7b53ae23dfc6a7fb12d0fc058b89b6e948f48448/src/CommunityToolkit.Mvvm/Messaging/Internals/System/Collections.Generic/Dictionary2.cs
...
public class SpecializedDictionary<TKey, TValue> : ISpecializedDictionary<TKey, TValue>
    ...
    where TValue : class?
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="SpecializedDictionary{TKey,TValue}"/> class.
    /// </summary>
    public SpecializedDictionary()
    {
        Initialize(0);
    }
    ...
    /// <summary>
    /// Enumerator for <see cref="SpecializedDictionary{TKey,TValue}"/>.
    /// </summary>
    public ref struct Enumerator
    {
        ...
        internal Enumerator(SpecializedDictionary<TKey, TValue> dictionary)
        {
