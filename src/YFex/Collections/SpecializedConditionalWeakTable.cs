...
/// with Weak References Handlers. In particular, it offers zero-allocation enumeration of stored items.
/// </summary>
...
public sealed class SpecializedConditionalWeakTable<TKey, TValue>
    where TKey : class
    where TValue : class?
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="SpecializedConditionalWeakTable{TKey,TValue}"/> class.
    /// </summary>
    public SpecializedConditionalWeakTable()
    {
    ...
    /// <summary>
    /// Provides an enumerator for the current <see cref="SpecializedConditionalWeakTable{TKey,TValue}"/> instance.
    /// </summary>
    public ref struct Enumerator
    {
        ...
        /// </summary>
        private SpecializedConditionalWeakTable<TKey, TValue> table;
        ...
        /// </summary>
        /// <param name="table">The input <see cref="SpecializedConditionalWeakTable{TKey,TValue}"/> instance being enumerated.</param>
        public Enumerator(SpecializedConditionalWeakTable<TKey, TValue> table)
        {
    ...
    /// <summary>
    /// A single entry within a <see cref="SpecializedConditionalWeakTable{TKey,TValue}"/> instance.
    /// </summary>
    ...
    {
        /// <summary>
        /// The <see cref="SpecializedConditionalWeakTable{TKey,TValue}"/> with which this container is associated.
        /// </summary>
        private readonly SpecializedConditionalWeakTable<TKey, TValue> parent;
        ...
        /// </summary>
        /// <param name="parent">The input <see cref="SpecializedConditionalWeakTable{TKey,TValue}"/> object associated with the current instance.</param>
        internal Container(SpecializedConditionalWeakTable<TKey, TValue> parent)
        {
        ...
        private Container(SpecializedConditionalWeakTable<TKey, TValue> parent, int[] buckets, Entry[] entries, int firstFreeEntry)
        {
            this.parent = parent;
