...
/// <summary>
/// Value-equatable wrapper around an array. Required for generator model types:
/// plain T[] uses reference equality and breaks the incremental caching step.
/// </summary>
    ...
    where T : IEquatable<T>
{
    ...
    public override int GetHashCode()
    {
        ...
        // FNV-1a style — HashCode is not available in netstandard2.0
        unchecked
        {
